{
  ...
  oxidized = {
    dependencies = ["asetus" "bcrypt_pbkdf" "ed25519" "net-ftp" "net-http-digest_auth" "net-scp" "net-ssh" "net-telnet" "ostruct" "psych" "rugged" "slop"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  oxidized-web = {
    dependencies = ["charlock_holmes" "emk-sinatra-url-for" "haml" "htmlentities" "json" "ostruct" "oxidized" "puma" "sinatra" "sinatra-contrib"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
