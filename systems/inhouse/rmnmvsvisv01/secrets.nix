...
}:
{
  sops.secrets = {
    ...
    unseal-token-1.sopsFile = flakeRoot + /secrets/secrets-vault/unseal-tokens-a.yaml;
    unseal-token-2.sopsFile = flakeRoot + /secrets/secrets-vault/unseal-tokens-a.yaml;
  };
