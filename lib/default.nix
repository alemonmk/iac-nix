...
let
  ...
  linuxPackageFrom = def: nixpkgs-next.legacyPackages."${linuxSystem}".callPackage def { };
  linuxPackagesFrom = def: nixpkgs-next.legacyPackages."${linuxSystem}".callPackages def { };
in
{
  inherit genAttrs;
